...
#define	AMLOGIC_FACTORY_RESET_REBOOT		0x05050505 //0x01010101
...
#define	AMLOGIC_INTERNAL_UPDATE_REBOOT		0x09090909
#define	AMLOGIC_SLIENCE_UPDATE_REBOOT		0x0a0a0a0a
#define	AMLOGIC_UPDATE_END_REBOOT		    0x0f0f0f0f
