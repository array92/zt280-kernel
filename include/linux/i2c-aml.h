...
{
	unsigned int scl_bank;
	unsigned int scl_bit;
	unsigned int sda_bank;
	unsigned int sda_bit;
};
...
struct aml_i2c_platform{
	...
	unsigned int 		ext_master_no;
	unsigned int		use_pio;/*0: hardware i2c, 1: manual pio i2c*/
	unsigned int		ext_use_pio;
	unsigned int		master_i2c_speed;
	unsigned int		ext_master_i2c_speed;
	...
	struct aml_sw_i2c_pins master_a_sw_pins; //for i2c recovery mode
	struct aml_sw_i2c_pins master_b_sw_pins; 
};
