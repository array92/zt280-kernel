...
#endif
{
    ...
    printk("hw : HDMI intr_handler %x\n",data32);
    if (data32 & (1 << 0)) {  //HPD rising 
    	
    	m_control_codec_power = 1;
        ...
        case HDMI_576i50_16x9:
            switch(audio_param->sample_rate)
            {
                ...
                case FS_176K4:
                    ...
                    break;
                case FS_48K:
                    audio_N_para = 6144*2;  //HDMI CT 7-29 CTS Transmitting Interval
                    break;
                case FS_96K:
                    audio_N_para = 12288;
                    break;
