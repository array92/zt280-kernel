...
void mali_core_renderunit_register_write(mali_core_renderunit *core, u32 relative_address, u32 new_val)
{
	...
	MALI_DEBUG_PRINT(6, ("mali_core_renderunit_register_write: Core:%s Addr:0x%04X Val:0x%08x map:0x%x\n",
            core->description,relative_address, new_val,core->registers_mapped));
